...
def get_dataset(dataset, transform_train, transform_val, mode, args,):
    ...
    elif dataset == 'ThoracicCXR':
        dataset_train = ThoracicCXR(args.data_path, train=True, transform=transform_train)
        dataset_val = ThoracicCXR(args.data_path, train=False, transform=transform_val)
    else:
